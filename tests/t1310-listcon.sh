...
>>> TODOTXT_SIGIL_BEFORE_PATTERN='\(w:\)\?' todo.sh listcon
@GinaTrapani
@OtherContributors
@home)
@x
...
>>> TODOTXT_SIGIL_BEFORE_PATTERN='(\?' TODOTXT_SIGIL_AFTER_PATTERN=')\?' todo.sh listcon
@GinaTrapani
@home
@school
@x
...
>>> TODOTXT_SIGIL_VALID_PATTERN='.\{2,\}' TODOTXT_SIGIL_BEFORE_PATTERN='\(w:\|(\)\?' TODOTXT_SIGIL_AFTER_PATTERN=')\?' todo.sh listcon
@GinaTrapani
@OtherContributors
@home
@school
